...
class TestEntityIndexing:
    ...
    def test_single_id_format(self):
        ...
        with patch.object(works, '_get_from_url_async', side_effect=mock_get_from_url_async):
            works["W123"]
...
class TestUtilityFunctions:
    ...
    def test_from_id_work(self):
        ...
        with patch('pyalex.client.async_session.async_get_with_retry', side_effect=mock_get_with_retry):
